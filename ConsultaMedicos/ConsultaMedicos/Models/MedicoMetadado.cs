...
namespace ConsultaMedicos.Models
{
    ...
    {
        [Required(ErrorMessage = "Obrigatório informar o CRM")] //obrigatório o preenchimento, se ficar em branco, surge essa mensagem de erro
        [StringLength(30, ErrorMessage = "O CRM deve possuir no máximo 30 caracteres")] //tamanho máximo e mensagem de erro caso seja excedido
